//
//  AddClientMeasurementsField.swift
//  MyFitMembers
//
...
import UIKit
protocol DelegateAddClientMeasurementsField {
    func delegateAddClientMeasurementsField(fieldName:String)
}

class AddClientMeasurementsField: UIView {
    ...
    func loadViewFromNib() -> UIView {
        ...
        let nib = UINib(nibName: "AddClientMeasurementsField", bundle: bundle)
